...
// import * as AuthProvider from '../hook/AuthProvider'
...
const SignUpPage = (props) => {
    ...
    // const { registerforKH } = useContext(AuthProvider.AuthContext);
    ...
    const validateForm = () => {
        if (fullname != '' && birthday != '' && phone != ''  && email != '' && password != '' && againPass != '') {
    ...
    const handleSignup = async (e) => {
        ...
        if (password == againPass) {
            ...
            if(response.success) {
                setErrors("")
                SetIsSuccess(response.message + "Please checking mail to verify your email!");
                setFullName('')
                setAddress('')
                setAgainPass('')
                setBirthday('')
                ...
                setErrors(response?.message||"An unknown error occurred!");
                return;
            }
        }
        else {
                ...
                <div className="col-sm-6 col-md-5 col-lg-4">
                    <div style={{ border: "2px solid grey", borderRadius: "5px", boxShadow: "3px 3px #888888", marginTop: "70px" }} align="center">
                        <form>
                            ...
                            {isSuccess != "" &&errors == ""&&<div className="alert alert-success" role="alert">
                                {isSuccess}
                            </div>}
