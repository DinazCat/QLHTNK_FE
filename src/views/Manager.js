              ...
              <ul className="nav nav-pills d-flex flex-column" id="menu">
                <li className="nav-item mt-2 mb-2">
                  <NavLink to="/manager/schedule" className="nav-link">
                    <img src="/images/qlylichhen_48px.png" alt="" />{" "}
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/quanlynhanvien" className="nav-link">
                    <img src="/images/qlynhanvien_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý nhân viên
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/patient" className="nav-link">
                    <img src="/images/quanlybenhnhan_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý bệnh nhân
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/deviceUsed" className="nav-link">
                    <img src="/images/ghilaivattuthietbi_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Thiết bị sử dụng
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/baocao" className="nav-link">
                    <img src="/images/xembaocao_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Báo cáo, thống kê
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/quanlykho" className="nav-link">
                    <img src="/images/qlykho_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">Quản lý kho</span>
                  </NavLink>
                </li>
                <li className="nav-item mb-2">
                  <NavLink to="/manager/bill" className="nav-link">
                    <img src="/images/qlyhoadon_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý hoá đơn
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/quanlydichvu" className="nav-link">
                    <img src="/images/qlydichvu_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý dịch vụ
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/quanlychinhanh" className="nav-link">
                    <img src="/images/qlychinhanh_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý chi nhánh
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/quanlymagiamgia" className="nav-link">
                    <img src="/images/giamgia_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý mã giảm giá
                    </span>
                  </NavLink>
                ...
                <li className="nav-item mb-2">
                  <NavLink to="/manager/quanlydanhgia" className="nav-link">
                    <img src="/images/tiepnhandanhgia_48px.png" alt="" />{" "}
                    <span className="ms-1 d-none d-sm-inline">
                      Quản lý phản hồi
                    </span>
                  </NavLink>
